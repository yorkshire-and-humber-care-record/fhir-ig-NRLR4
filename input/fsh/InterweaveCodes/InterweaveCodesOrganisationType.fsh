ValueSet: InterweaveOrganizationType
Id: Interweave-OrganizationType
Title: "InterweaveOrganizationType"
Description: "Organization Types, as used by ODS"
* ^status = #draft
* ^version = "0.0.1"
* ^date = "2024-07-15"
* ^name = "InterweaveOrganizationType"
* ^experimental = false

* include codes from system Interweave-OrganizationType

CodeSystem: InterweaveOrganizationType
Id: Interweave-OrganizationType
Title: "InterweaveOrganizationType"
Description: "Organization Types, as used by ODS"
* ^name = "InterweaveOrganizationType"
...
* ^version = "0.0.1"
* ^date = "2024-07-15"
* ^url = "https://fhir.interweavedigital.nhs.uk/CodeSystem/Interweave-OrganizationType"
